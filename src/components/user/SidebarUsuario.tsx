...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
        d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871m-5.007 0h-.872c-.621 0-1.125.504-1.125 1.125v3.375m7.004-4.5a7.454 7.454 0 00.982-3.172M9.497 14.25a7.454 7.454 0 01-.981-3.172M5.25 4.236V2.721A48.13 48.13 0 0112 2.25c2.291 0 4.545.16 6.75.47v1.516M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 007.73 9.728m11.02-5.492c.982.143 1.954.317 2.916.52a6.003 6.003 0 01-5.395 4.972" />
    ),
  },
  {
    label: 'Ajuda',
