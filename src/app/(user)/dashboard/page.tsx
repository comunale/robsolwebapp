      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg shadow-lg p-8 text-white">
          ...
          <div className="flex gap-4">
            <Link href="/dashboard/scan" className="bg-white text-blue-600 px-6 py-3 rounded-lg font-medium hover:bg-blue-50 transition duration-200">
              Scan Receipt
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          <Link href="/dashboard/scan" className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition duration-200">
            ...
            <p className="text-gray-600 text-sm">Upload a receipt and let AI extract the data</p>
          </Link>
